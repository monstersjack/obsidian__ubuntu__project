...
直流无刷电机不能直接接电池转动，C620 电调的核心职能是：
- 把电池输出的 24V 直流电，转换成三相交流电，驱动 M3508 无刷电机旋转；
- 接收 STM32 发来的控制指令，精准调节电机的转速、转向、输出扭矩；
- 实时采集电机的转速、电流、温度数据，回传给主控做闭环控制。
简单说：STM32 只发 “转多少速” 的命令，C620 负责真正驱动电机转起来，是控制器和电机之间的驱动桥梁。
...
1.  **视觉感知：奥比中光HP60C深度相机**
	- 输出能力：同步输出RGB彩色图像与==深度点云数据==，RGB分辨率最高1920×1080，系统适配采用640×480分辨率平衡精度与传输带宽。
